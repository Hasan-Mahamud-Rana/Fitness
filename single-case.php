<?php get_header(); ?>
<!--single content goes here portfolio-->
<?php
global $post;
$postID = get_the_ID();
?>
<div class="tShadow">
  ...
  <div class="small-12 columns portfolio-relevant"><hr></div>
</div>
</div>
<div class="relevant-portfolio-panel portfolios-page">
  <div class="row" >
    <div class="large-12 text-center">
      <div class="relevant-portfolio">
    <?php $query = new WP_Query( array( 'post__not_in' => array($postID),'order' => 'ASC', 'post_type' => 'portfolio', 'post_status' => 'publish')); ?>
        ...
        <div <?php echo 'id="'.get_the_ID().'"'?> class="small-12 medium-4 large-4 columns cc">
          ...
          <div class="panel text-left portfolio-text">
