...
<div class="nyheder-panel nyheders-page">
        <?php $query = new WP_Query( 'order=desc&post_type=nyheder&posts_per_page=10&post_status=publish&paged='. get_query_var('paged')); ?>
        <?php if ( $query->have_posts() ) : while ( $query->have_posts() ) : $query->the_post(); ?>
      <div class="row" >
        <div class="small-12 medium-12 large-12 columns" data-equalizer="news">
          <div class="small-12 medium-4 large-3 columns nyheder-box" data-equalizer-watch="news">
          <div class="panel text-left nyheder-image">
            <a href="<?php the_permalink() ?>"><?php the_post_thumbnail( array(320,242) ); ?></a>
          </div>
        </div>
        <div class="small-12 medium-8 large-9 columns nyheder-box" data-equalizer-watch="news">
